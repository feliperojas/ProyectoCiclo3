function traerInformacion(){
	$.ajax({    
    url : 'https://gee0b27b2df2698-dbciclo3.adb.sa-saopaulo-1.oraclecloudapps.com/ords/admin/category/category',
	data: '{}',
    type : 'GET',
    dataType : 'json',
...
function nuevaInformacion(){
	...
	$.ajax(    
    'https://gee0b27b2df2698-dbciclo3.adb.sa-saopaulo-1.oraclecloudapps.com/ords/admin/category/category',
	{data: datosJson,
    type : 'POST',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
...
function editarRegistro(id){
	$.ajax({    
    url : 'https://gee0b27b2df2698-dbciclo3.adb.sa-saopaulo-1.oraclecloudapps.com/ords/admin/category/category/'+id,
	data: "{}",
    type : 'GET',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
